                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input class="block w-full rounded-xl bg-slate-900/60 border border-slate-700 text-slate-100 py-2.5 px-4 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20" type="password" name="password" required placeholder="••••••••" />
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-slate-300 uppercase mb-2">Confirmer le mot de passe</label>
                            <input class="block w-full rounded-xl bg-slate-900/60 border border-slate-700 text-slate-100 py-2.5 px-4 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20" type="password" name="password_confirmation" required placeholder="••••••••" />
                        </div>
                    </div>
                </div>
            </div>
